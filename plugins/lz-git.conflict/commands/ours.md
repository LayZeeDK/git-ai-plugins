---
description: Accept current branch version for all conflicts or a specific file
...
Accept the current branch (ours) version for all conflicts or a specific file.

This is useful when you know the current branch's version is correct and want to discard all incoming changes.
...
- Explain that all incoming changes will be discarded
...
- List of files that accepted current branch version
